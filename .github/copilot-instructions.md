...
This project includes a skill (`skills/fitbit-export/SKILL.md`) written for Claude Code. When executing in Cursor, use these tool equivalents:

| Skill references | Cursor equivalent |
|-----------------|-------------------|
| `Bash(command)` | `run_terminal_command(command)` |
